...
def load_model(cfg, dict_config, wandb_id, callbacks):
    ...
    """
    directory = cfg.checkpoints.dirpath
    if cfg.dataset.val_dataset.embedding_name == "street_clip":
        weights_path = "/home/t21bfade/gpfs/t21bfade/DisasterPlonk/plonk/osm.safetensors"
    else:
        weights_path = "/home/t21bfade/gpfs/t21bfade/DisasterPlonk/plonk/yfcc.safetensors"
    logger = instantiate(cfg.logger, id=wandb_id, resume="allow")
    ...
    for k, v in state_dict.items():
        ...
        new_state_dict[f"ema_network.{k}"] = v
    model.load_state_dict(new_state_dict, strict=True)  # strict=False allows missing keys if needed
    ckpt_path = None
